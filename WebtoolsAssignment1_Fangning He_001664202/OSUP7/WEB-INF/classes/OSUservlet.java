...
public class OSUservlet extends HttpServlet{
	...
	out.println("<html>");
	out.println("<head>");
    out.println("<title>"+"Physician Referral Formout"+"</title>");
    out.println("<meta charset='UTF-8'>");
    out.println("<meta name='viewport' content='width=device-width, initial-scale=1.0'>");
	out.println("<script src='https://ajax.googleapis.com/ajax/libs/jquery/2.2.2/jquery.min.js'>" + "</script>");
	
	out.println("<style type = 'text/css'> h1{color:#900000; }p{ font-family: Arial, Helvetica, sans-serif;  padding: 0px;}#p1{font-size: 170% ; }#p2,#p3,#p12{font-size: 75%;}#p4,#p6,#p9{color:#900000;font-size:125%;} #p11{font-size:125%;}#submit{font-family: Courier, 'Lucida Console', monospace; border:#900000 1px solid;width:200px; height:50px;font-size: 200% } </style>");
    ...
    out.println("<script> $(document).ready(function() {$( '#birth' ).datepicker({changeMonth: true,changeYear: true});});</script>");
    
    
	out.println("</head>");
	out.println("<body>");
	out.println("<form action='osu.htm' method='post'>");
        ...
        out.println("<p id = 'p1'>");
			...
			out.println("Yes" + "<input id ='yes' type ='Radio' name ='langs' value ='yes'>") ;
			out.println("</lable>");
			out.println("No" + "<input type ='Radio' name ='langs' value ='no'>");
        out.println("</p>");
        ...
        out.println("<p id='p10'>");
            ...
            out.println("</lable>");
            out.println("<lable style='float: left; width: 275px;'>"+"<input type = 'text' name = 'pextention' style = 'height:23px; width:100px; border-color: black; '>"+"</lable>");
...
out.println("</html>");
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/* for(int i = 0 ; i < reasonchoose.length; i++){
			out.println("referral or not:" + reasonchoose[i]);
		} */
