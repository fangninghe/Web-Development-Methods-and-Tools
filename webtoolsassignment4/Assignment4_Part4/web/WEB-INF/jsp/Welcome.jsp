<%-- 
    Document   : Welcome
    Created on : Jun 7, 2016, 9:32:52 PM
    Author     : Alex
--%>
...
<html>
    <head>
        ...
        <title>Welcome to add Books</title>
    ...
    <body>
        ...
        <div id="question" name = "question" style = "display : block">
            ...
            <input type = "text" name = "book"  id = "booknumber" style = "height:23px; width:200px; border-color: black;"/><br/>

            <button  onclick = "number()">Submit</button><br/><br/>
            <a href="searchbooks.htm?action=search">Or You Can Click Here To Search Books</a>
        </div>
    </body>
</html>
